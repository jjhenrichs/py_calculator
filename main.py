...
two_btn = tk.Button(button_frame, text="2", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
two_btn.grid(column=1, row=0, padx=5, pady=5)

three_btn = tk.Button(button_frame, text="3", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
three_btn.grid(column=2, row=0, padx=5, pady=5)

add_btn =tk.Button(button_frame, text="+", bg='#008080', fg='#fff', width=2, height=1, font=style, padx=8, pady=5)
add_btn.grid(column=3, row=0, padx=5, pady=5)

four_btn = tk.Button(button_frame, text="4", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
four_btn.grid(column=0, row=1, padx=5, pady=5)

five_btn = tk.Button(button_frame, text="5", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
five_btn.grid(column=1, row=1, padx=5, pady=5)

six_btn = tk.Button(button_frame, text="6", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
six_btn.grid(column=2, row=1, padx=5, pady=5)

sub_btn =tk.Button(button_frame, text="-", bg='#008080', fg='#fff', width=2, height=1, font=style, padx=8, pady=5)
sub_btn.grid(column=3, row=1, padx=5, pady=5)

seven_btn = tk.Button(button_frame, text="7", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
seven_btn.grid(column=0, row=2, padx=5, pady=5)

eight_btn = tk.Button(button_frame, text="8", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
eight_btn.grid(column=1, row=2, padx=5, pady=5)

nine_btn = tk.Button(button_frame, text="9", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
nine_btn.grid(column=2, row=2, padx=5, pady=5)

mult_btn = tk.Button(button_frame, text="x", bg='#008080', fg='#fff', width=2, height=1, font=style, padx=8, pady=5)
mult_btn.grid(column=3, row=2, padx=5, pady=5)

decimal_btn = tk.Button(button_frame, text=".", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
decimal_btn.grid(column=0, row=3, padx=5, pady=5)

zero_btn = tk.Button(button_frame, text="0", bg='#FFF', fg='#008080', width=2, height=1, font=style, padx=8, pady=5)
